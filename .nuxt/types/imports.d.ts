...
export {}
declare global {
  const ALLOWED_EMAIL_DOMAINS: typeof import('../../composables/useAuth').ALLOWED_EMAIL_DOMAINS
  ...
  const isEmailAllowed: typeof import('../../composables/useAuth').isEmailAllowed
  ...
  const useSupabase: typeof import('../../utils/supabase').useSupabase
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { AdminRole, CrudAction, SectionPermissions, AdminRecord } from '../../composables/useAuth'
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly ALLOWED_EMAIL_DOMAINS: UnwrapRef<typeof import('../../composables/useAuth')['ALLOWED_EMAIL_DOMAINS']>
    ...
    readonly isEmailAllowed: UnwrapRef<typeof import('../../composables/useAuth')['isEmailAllowed']>
    ...
    readonly useSupabase: UnwrapRef<typeof import('../../utils/supabase')['useSupabase']>
