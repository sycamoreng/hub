...
import { defineComponent, computed, ref, watch, mergeProps, withCtx, createVNode, toDisplayString, unref, useSSRContext, createElementBlock, shallowRef, getCurrentInstance, provide, cloneVNode, h } from "vue";
...
import { _ as _imports_0 } from "./virtual_public-BhHsw8T-.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="text-xs text-slate-400">sycamore.ng © 2025</div></div></aside>`);
...
//# sourceMappingURL=default-DakvrUEC.js.map
