...
<template>
  <div class="max-w-6xl mx-auto">
    ...
    <section class="bg-white border border-slate-200 rounded-xl overflow-x-auto mt-8">
      ...
      <table v-else class="w-full text-xs sm:text-sm min-w-[640px]">
        <thead class="bg-slate-50 text-slate-500 text-[10px] sm:text-xs uppercase tracking-wide">
          <tr>
            ...
            <th class="text-left px-3 sm:px-5 py-2">From</th>
            <th class="text-left px-3 sm:px-5 py-2">To</th>
            <th class="text-right px-3 sm:px-5 py-2">Days</th>
            <th class="text-left px-3 sm:px-5 py-2">Status</th>
            <th class="text-left px-3 sm:px-5 py-2">Relief</th>
