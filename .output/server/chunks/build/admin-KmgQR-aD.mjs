...
import { defineComponent, ref, watch, mergeProps, unref, withCtx, createTextVNode, computed, createVNode, toDisplayString, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderSlot, ssrRenderList, ssrRenderClass, ssrRenderStyle } from 'vue/server-renderer';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const activeGroupId = computed(() => {
      var _a, _b, _c, _d;
      return (_d = (_c = (_a = visibleGroups.value.find(groupContainsActive)) == null ? void 0 : _a.id) != null ? _c : (_b = visibleGroups.value[0]) == null ? void 0 : _b.id) != null ? _d : "";
    });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="p-4 border-t border-slate-800 text-xs"><div class="text-slate-400 truncate mb-2">${ssrInterpolate((_a = unref(user)) == null ? void 0 : _a.email)}</div><div class="flex gap-2">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
      ...
      if (unref(sidebarOpen)) {
        ...
        _push(ssrRenderComponent(_component_AdminNav, null, null, _parent));
        _push(`</div><div class="p-4 border-t border-slate-800 text-xs"><div class="text-slate-400 truncate mb-2">${ssrInterpolate((_b = unref(user)) == null ? void 0 : _b.email)}</div><button class="w-full px-2 py-1.5 rounded-md bg-slate-800 text-slate-200">Sign out</button></div></aside>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=admin-KmgQR-aD.mjs.map
