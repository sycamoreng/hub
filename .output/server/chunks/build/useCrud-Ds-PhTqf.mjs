...
import { ref, defineComponent, watch, unref, useSSRContext } from 'vue';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(` ${ssrInterpolate((_a = __props.newLabel) != null ? _a : "New")}</button></div><div class="card overflow-hidden">`);
      if (__props.loading) {
    ...
    watch(() => [props.open, props.initial], () => {
      ...
      if (props.open) {
        ...
        for (const f of props.fields) {
          const v = (_a = props.initial) == null ? void 0 : _a[f.key];
          form.value[f.key] = v != null ? v : f.type === "checkbox" ? false : "";
        }
        errors.value = {};
      }
    }, { immediate: true });
...
function useCrud(table) {
  ...
  async function load(orderBy = [{ column: "created_at", ascending: false }]) {
    ...
    try {
      ...
      for (const o of orderBy) q = q.order(o.column, { ascending: (_a = o.ascending) != null ? _a : true });
      const { data, error: e } = await q;
      if (e) throw e;
      items.value = data != null ? data : [];
    } catch (e) {
      error.value = (_b = e.message) != null ? _b : "Failed to load";
    } finally {
      loading.value = false;
    }
  }
...
export { _sfc_main$1 as _, _sfc_main as a, useCrud as u };
//# sourceMappingURL=useCrud-Ds-PhTqf.mjs.map
