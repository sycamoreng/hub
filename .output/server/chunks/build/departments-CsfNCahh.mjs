    ...
    async function save(payload) {
      ...
      try {
        const data = {
          ...
          head_name: (_b = payload.head_name) != null ? _b : "",
          head_title: (_c = payload.head_title) != null ? _c : "",
          head_email: (_d = payload.head_email) != null ? _d : ""
        };
...
//# sourceMappingURL=departments-CsfNCahh.mjs.map
